...
View(new_hope_chars) # Can see those in A New Hope + Others!
...
slice_min(starwars, order_by = mass, n = 10) #have to give column you want to order by first! Gives rows with lowest 10 masses.
